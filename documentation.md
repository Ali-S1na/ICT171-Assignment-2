...
For this project, a free template is used from [Start Bootstrap] (https://startbootstrap.com/template/scrolling-nav) which is licensed under the [MIT License] (https://opensource.org/licenses/MIT). The following changes are made to the website to make it a better fit for this project.